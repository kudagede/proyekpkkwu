<div id="colorlib-page">
    ...
    <aside id="colorlib-aside" role="complementary" class="js-fullheight">
        ...
        <h1 id="colorlib-logo" class="mb-4 mb-md-5"><a href="index.html" style="background-image: url(assets/images/bg_1.jpg);">Mostudio</a></h1>
        <nav id="colorlib-main-menu" role="navigation">
            <ul>
                <li><a href="index.html">Home</a></li>
                <li class="colorlib-active"><a href="<?= base_url("/home/gallery") ?>">Gallery</a></li>
